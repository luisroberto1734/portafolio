...
#config
st.set_page_config(page_title="LuisRobertoapp", page_icon="🤖", layout="wide")
...
email_address ="roberto.silvac011@gmail.com "

lottie_file ="https://assets9.lottiefiles.com/packages/lf20_ggwq3ysg.json"

with st.container():
    st.subheader("Hola, somos Luis Roberto Silva :wave:")
    st.title("Creamos soluciones para acelerar tus proyecto y finanzas")
    st.write(
        "Somos unos apasionados de la tecnología y la innovación, especializados en el sector de la digitalización y automatización de negocios asi como en finanzas. Nos gusta crear soluciones para resolver problemas y mejorar procesos."
    )
...
with st.container():
    ...
    with text_column:
        ...
        st.write(
            """
            Si en tus procesos diarios tienes que introducir información en diferentes fuentes de datos o bien tienes que trabajar con documentación en papel, es hora de pensar en implementar una aplicación en tu negocio para potenciar y optimizar el funcionamiento de los procesos diarios con reportes.    
            """
        )
